...
_C.DATA = CN()
#
_C.DATA.cache_path = './cache'
_C.DATA.data_path = 'G:/桌面/ViT-NeT-main/data'
#_C.DATA.dataset == 'Epilepsy'
_C.DATA.batch_size = 8
#

# Batch size for a single GPU, could be overwritten by command line argument
_C.DATA.BATCH_SIZE = 8#256
...
_C.MODEL = CN()
# Model type
_C.MODEL.TYPE = 'swin_tree'
# Model name
_C.MODEL.NAME = 'swin_base_patch4_window7_224_22k'
# Pretrained weight from checkpoint, could be imagenet22k pretrained weight
# could be overwritten by command line argument
_C.MODEL.PRETRAINED = ''  # swin_base_patch4_window7_224_22k.pth'
...
# _C.MODEL.TREE_DEPTH = 5
_C.MODEL.TREE = CN()
_C.MODEL.TREE.DEPTH = 2#4
_C.MODEL.TREE.PROTO_SIZE = [1, 1]
